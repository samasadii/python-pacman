...
def enemy():
    ...
    while i<enemies:
        ...
        if [xen,yen] not in (enemiesList and wallList):
            print Fore.MAGENTA +place(xen,yen) +chr(235)
            enemiesList+=[[xen,yen]]
            i+=1
...
def enemy_move():
    ...
    while i<enemies:
        ...
        if go==1 and (([enemiesList[i][0],enemiesList[i][1]-1] not in wallList)):  #up
            enemiesList[i][1]-=1
            print Fore.MAGENTA  + Back.RESET +place(enemiesList[i][0],enemiesList[i][1]) +chr(235)
            ...
            enemiesList[i][0]-=1
            print Fore.MAGENTA  + Back.RESET  + Back.RESET +place(enemiesList[i][0],enemiesList[i][1]) +chr(235)
            if [enemiesList[i][0]+1,enemiesList[i][1]] in stars:
                print Fore.CYAN  + Back.RESET +place(enemiesList[i][0]+1,enemiesList[i][1]) +" "
            else:
                print Fore.WHITE  + Back.RESET +place(enemiesList[i][0]+1,enemiesList[i][1]) +chr(249)
...
def menu():
    ...
    while True:
        ...
        if i==2 and where=="\r":
            ...
            while True:
                if msvcrt.kbhit() or msvcrt.getch()=="\r":
                    where=" "
                    os.system("cls")
                    break
        if i==3 and where=="\r":
