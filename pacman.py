    ...
    while True:
        if msvcrt.kbhit():
            while True:
                ...
                if msvcrt.kbhit():
                    ch=msvcrt.getch()
                if ord(ch)==72 or ord(ch)==80 or ord(ch)==77 or ord(ch)==75 or ch=="p":
                    way=ch
                if ord(way)==72 and ([rl,du-1] not in wallList): #up
                    du-=1
                ...
                elif ord(way)==80 and ([rl,du+1] not in wallList): #down
                    du+=1
                    print Fore.WHITE  + Back.RESET + place(rl,du-1) +" "
                    ...
                    if [rl,du] not in stars:
                        ...
                        score+=1
                        print place(35,1)+ Back.BLUE + "Score \""+str(score)+"\""
                elif ord(way)==77 and ([rl+1,du] not in wallList): #right
                    rl+=1
                    ...
                    if [rl,du] not in stars:
                        ...
                        score+=1
                        print place(35,1)+ Back.BLUE + "Score \""+str(score)+"\""
                elif ord(way)==75 and ([rl-1,du] not in wallList): #left
                    rl-=1
                    print Fore.WHITE  + Back.RESET + place(rl+1,du) +" "
                    print Fore.YELLOW  +Style.BRIGHT+ Back.RESET + place(rl,du) +"@"
                    if [rl,du] not in stars:
                ...
                if [rl,du] in enemiesList or score==1879:
                    ...
                    print Back.WHITE+" "
                    os.system("cls")
                    print Fore.CYAN+Style.BRIGHT+place(conx/2-3,cony/2-7)+"Game Over"
                    print Fore.BLUE+Style.BRIGHT+place(conx/2-4,cony/2-5)+"Score : "+str(score)
                    print Fore.MAGENTA+Style.BRIGHT+place(conx/2-8,cony/2)+"press \"enter\" to exit"
                    while True:
                        if msvcrt.getch()=="\r":
                            print Back.RESET+" "
                            os.system("cls")
